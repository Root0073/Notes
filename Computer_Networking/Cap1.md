...
例如以太网使用48位地址，当你购买一个以太网卡时，他已经被分配了一个唯一的以太网地址

尽管链路层地址和网络层地址在协议层面上是完全独立的，但是在分配和管理方面，他们可能并非如此

我们经常能看到这样的设置：网关或路由器有多个接口，每个接口都有自己的链路层地址来标识网卡,同时也有自己的网络层地址来标识网卡所属网络中的主机
